...
$_['help_message_template'] = 'Сообщение, котороу будет получать покупатель при изменении статуса заказа. {OrderID} - номер заказа, {Status} - текущий статус заказа, {StoreName} - название магазина.';
$_['help_message_customer'] = 'Сообщение, котороу будет получать покупатель при создании заказа. {OrderID} - номер заказа, {StoreName} - название магазина.';
$_['help_message_admin']    = 'Сообщение, котороу будет получать администратор при создании нового заказа. {OrderID} - номер заказа, {StoreName} - название магазина, {Total} - сумма заказа.';
?>